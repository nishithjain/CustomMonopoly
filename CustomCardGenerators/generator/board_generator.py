...
def apply_inner_box(html: str, edition_id: str, html_output_path: Path) -> tuple[str, dict]:
    """
    Point the 37 cm center at an edition InnerBox.png, or leave it empty.

    Never falls back to another edition or to assets/common/InnerBox.png.
    """
...
def generate_board(
    ...
    template_path = template_path or (TEMPLATES_DIR / "board.html")
    ...
    updated_html, inner_status = apply_inner_box(updated_html, edition_id, output_path)
