"""Command-line interface for the Monopoly edition generator."""
...
from monopoly_edition_generator.paths import PROJECT_ROOT, configure_stdio
from monopoly_edition_generator.pipeline import GenerationOptions, run_generation
from monopoly_edition_generator.validator import ValidationResult
...
def print_banner(edition_id: str) -> None:
    print("=" * 50)
    print(" Monopoly Edition Generator")
    print("=" * 50)
    print()
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.gui:
        from monopoly_edition_generator.gui import main as gui_main
