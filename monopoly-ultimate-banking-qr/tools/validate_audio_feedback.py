...
OTHER_SOUND_SOURCES = {
    ...
    "LOCATION": ("Resources/Common/Sounds/Other/Location.mp3", "location.mp3"),
    "GO_TO_JAIL": ("Resources/Common/Sounds/Other/GoToJail.mp3", "go_to_jail.mp3"),
    "JAIL_RELEASE": ("Resources/Common/Sounds/Other/Jail.mp3", "jail.mp3"),
    "JAIL_PASS": ("Resources/Common/Sounds/Other/JailPass.mp3", "jail_pass.mp3"),
    "BANK_CREDIT": ("Resources/Common/Sounds/Other/KaChing.mp3", "ka_ching.mp3"),
    ...
    "ENERGY_GRID_PURCHASED": ("Resources/Common/Sounds/Other/EnergyGridPurchased.mp3", "energy_grid_purchased.mp3"),
    "RENT_TRANSFER": ("Resources/Common/Sounds/Other/RentTransfer.mp3", "rent_transfer.mp3"),
    "RENT_RELIEF": ("Resources/Common/Sounds/Other/RentRelief.mp3", "rent_relief.mp3"),
    ...
    "PROPERTY_SOLD": ("Resources/Common/Sounds/Other/PropertySold.mp3", "property_sold.mp3"),
    "SCAN_CARD": ("Resources/Common/Sounds/Other/ScanCard.mp3", "scan_card.mp3"),
    "EVENT_APPLIED": ("Resources/Common/Sounds/Other/EventApplied.mp3", "event_applied.mp3"),
    "TURN_CHANGED": ("Resources/Common/Sounds/Other/TurnChanged.mp3", "turn_changed.mp3"),
    "TURN_SKIPPED": ("Resources/Common/Sounds/Other/TurnSkipped.mp3", "turn_skipped.mp3"),
    "EXTRA_TURN": ("Resources/Common/Sounds/Other/ExtraTurn.mp3", "extra_turn.mp3"),
    "DICE_ROLL": ("Resources/Common/Sounds/Other/DiceRoll.mp3", "dice_roll.mp3"),
    "MOVE_PLAYER": ("Resources/Common/Sounds/Other/MovePlayer.mp3", "move_player.mp3"),
    "LUCKY_DRAW": ("Resources/Common/Sounds/Other/LuckyDraw.mp3", "lucky_draw.mp3"),
    "BANK_DEBIT": ("Resources/Common/Sounds/Other/SomeoneJustTookYourMoney.mp3", "someone_just_took_your_money.mp3"),
    "MONEY_TRANSFER": ("Resources/Common/Sounds/Other/MoneyTransfer.mp3", "money_transfer.mp3"),
