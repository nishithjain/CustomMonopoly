...
OTHER_SOUND_MAPPINGS = [
    ...
    ("Resources/Common/Sounds/Other/Location.mp3", "location.mp3"),
    ("Resources/Common/Sounds/Other/GoToJail.mp3", "go_to_jail.mp3"),
    ("Resources/Common/Sounds/Other/Jail.mp3", "jail.mp3"),
    ("Resources/Common/Sounds/Other/JailPass.mp3", "jail_pass.mp3"),
    ...
    ("Resources/Common/Sounds/Other/EnergyGridPurchased.mp3", "energy_grid_purchased.mp3"),
    ("Resources/Common/Sounds/Other/RentTransfer.mp3", "rent_transfer.mp3"),
    ("Resources/Common/Sounds/Other/RentRelief.mp3", "rent_relief.mp3"),
    ...
    ("Resources/Common/Sounds/Other/PropertySold.mp3", "property_sold.mp3"),
    ("Resources/Common/Sounds/Other/ScanCard.mp3", "scan_card.mp3"),
    ("Resources/Common/Sounds/Other/EventApplied.mp3", "event_applied.mp3"),
    ("Resources/Common/Sounds/Other/TurnChanged.mp3", "turn_changed.mp3"),
    ("Resources/Common/Sounds/Other/TurnSkipped.mp3", "turn_skipped.mp3"),
    ("Resources/Common/Sounds/Other/ExtraTurn.mp3", "extra_turn.mp3"),
    ("Resources/Common/Sounds/Other/DiceRoll.mp3", "dice_roll.mp3"),
    ("Resources/Common/Sounds/Other/MovePlayer.mp3", "move_player.mp3"),
    ("Resources/Common/Sounds/Other/LuckyDraw.mp3", "lucky_draw.mp3"),
    ("Resources/Common/Sounds/Other/SomeoneJustTookYourMoney.mp3", "someone_just_took_your_money.mp3"),
    ("Resources/Common/Sounds/Other/MoneyTransfer.mp3", "money_transfer.mp3"),
