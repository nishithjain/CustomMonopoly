...
PROPERTY_CARDS: list[CardSpec] = [
    CardSpec("PRP_01", "PROPERTY", 1, "Old Kent Road", "01_Property_Back_QR.png", "01_Property_Front.png"),
    CardSpec("PRP_02", "PROPERTY", 2, "Whitechapel Road", "02_Property_Back_QR.png", "02_Property_Front.png"),
    CardSpec("PRP_03", "PROPERTY", 3, "The Angel, Islington", "03_Property_Back_QR.png", "03_Property_Front.png"),
    CardSpec("PRP_04", "PROPERTY", 4, "Euston Road", "04_Property_Back_QR.png", "04_Property_Front.png"),
    CardSpec("PRP_05", "PROPERTY", 5, "Pentonville Road", "05_Property_Back_QR.png", "05_Property_Front.png"),
    CardSpec("PRP_06", "PROPERTY", 6, "Pall Mall", "06_Property_Back_QR.png", "06_Property_Front.png"),
    CardSpec("PRP_07", "PROPERTY", 7, "Whitehall", "07_Property_Back_QR.png", "07_Property_Front.png"),
    CardSpec("PRP_08", "PROPERTY", 8, "Northumberland Avenue", "08_Property_Back_QR.png", "08_Property_Front.png"),
    CardSpec("PRP_09", "PROPERTY", 9, "Bow Street", "09_Property_Back_QR.png", "09_Property_Front.png"),
    CardSpec("PRP_10", "PROPERTY", 10, "Marlborough Street", "10_Property_Back_QR.png", "10_Property_Front.png"),
    CardSpec("PRP_11", "PROPERTY", 11, "Vine Street", "11_Property_Back_QR.png", "11_Property_Front.png"),
    CardSpec("PRP_12", "PROPERTY", 12, "Strand", "12_Property_Back_QR.png", "12_Property_Front.png"),
    CardSpec("PRP_13", "PROPERTY", 13, "Fleet Street", "13_Property_Back_QR.png", "13_Property_Front.png"),
    CardSpec("PRP_14", "PROPERTY", 14, "Trafalgar Square", "14_Property_Back_QR.png", "14_Property_Front.png"),
    CardSpec("PRP_15", "PROPERTY", 15, "Leicester Square", "15_Property_Back_QR.png", "15_Property_Front.png"),
    CardSpec("PRP_16", "PROPERTY", 16, "Coventry Street", "16_Property_Back_QR.png", "16_Property_Front.png"),
    CardSpec("PRP_17", "PROPERTY", 17, "Piccadilly", "17_Property_Back_QR.png", "17_Property_Front.png"),
    CardSpec("PRP_18", "PROPERTY", 18, "Regent Street", "18_Property_Back_QR.png", "18_Property_Front.png"),
    CardSpec("PRP_19", "PROPERTY", 19, "Oxford Street", "19_Property_Back_QR.png", "19_Property_Front.png"),
    CardSpec("PRP_20", "PROPERTY", 20, "Bond Street", "20_Property_Back_QR.png", "20_Property_Front.png"),
    CardSpec("PRP_21", "PROPERTY", 21, "Park Lane", "21_Property_Back_QR.png", "21_Property_Front.png"),
    CardSpec("PRP_22", "PROPERTY", 22, "Mayfair", "22_Property_Back_QR.png", "22_Property_Front.png"),
]
